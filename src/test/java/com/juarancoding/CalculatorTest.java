...
public class CalculatorTest {
    ...
    public void testMultiply(){
        ...
        MobileElement numTwo = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/digit_2"));
        numTwo.click();
        MobileElement btnMultiply = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/op_mul"));
        btnMultiply.click();
        MobileElement numFour = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/digit_4"));
        numFour.click();
        MobileElement equal = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/eq"));
        ...
        MobileElement result = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/result_final"));
        String txtResult = result.getText();
        Assert.assertEquals(txtResult, "8");
    }

    @Test
    public void testDivide(){
        // 8 / 2 = 4
        MobileElement numEight = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/digit_8"));
        numEight.click();
        MobileElement btnDivide = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/op_div"));
        btnDivide.click();
        MobileElement numTwo = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/digit_2"));
        numTwo.click();
        MobileElement equal = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/eq"));
        ...
        MobileElement result = (MobileElement) driver.findElement(By.id("com.google.android.calculator:id/result_final"));
        String txtResult = result.getText();
        Assert.assertEquals(txtResult, "4");
        }
}
